...
var _customInput = require("./component/customInput");
var _customInputDefault = parcelHelpers.interopDefault(_customInput);
var _customCalc = require("./component/customCalc");
var _customCalcDefault = parcelHelpers.interopDefault(_customCalc);
var _incrementDecrement = require("./component/incrementDecrement");
var _incrementDecrementDefault = parcelHelpers.interopDefault(_incrementDecrement);
addEventListener("DOMContentLoaded", ()=>{
    (0, _customInputDefault.default)();
    (0, _customCalcDefault.default)();
    (0, _incrementDecrementDefault.default)();
});

},{"jquery":"hgMhh","./component/customInput":"3QJfu","./component/customCalc":"43Ngm","./component/incrementDecrement":"jYsSn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"3QJfu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function customInput() {
    function blockOptions(selectWithOptionsToBlock, dependentSelect) {
        ...
        dependentSelect.addEventListener("change", function() {
            if (isDependentOptionSelected()) selectWithOptionsToBlock.querySelectorAll("option").forEach(function(option) {
                // console.log(option);
                option.disabled = false;
            });
            else selectWithOptionsToBlock.querySelectorAll("option").forEach(function(option) {
    ...
    (0, _jqueryDefault.default)(document).ready(function() {
        ...
        function calculatePrice() {
            ...
            $corners.each(function() {
                (0, _jqueryDefault.default)(this).val() ? cornerTotal += cornerPrice * parseInt((0, _jqueryDefault.default)(this).val()) : cornerTotal = 0;
            });
            var basePrice = 0;
            $selects.each(function() {
                arr.unshift((0, _jqueryDefault.default)(this).val());
                if (arr.join() === "white,PVH") basePrice = basePricePvhWhite;
                else if (arr.join() === "colored,PVH") basePrice = basePricePvhColored;
